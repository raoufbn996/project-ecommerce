      ...
      <div className='w-full flex flex-col'>
        ...
        <div className='flex justify-between mb-2'>
          ...
          <div className=' flex gap-x-2 h-[36px] text-sm'>
            ...
            <div className='flex-1 flex items-center justify-around'>{price} Da</div>
            <div className='flex-1 flex justify-end items-cente text-primary font-medium'>{`${parseFloat(price*amount).toFixed(2)} Da`}</div>
           </div>
      </div>
    </div>
  </div>
